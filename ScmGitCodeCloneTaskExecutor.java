 ...
 */
@Component
public class ScmGitCodeCloneTaskExecutor implements ADPaaSTaskExecutor {

	private static final Logger logger = LoggerFactory.getLogger(ScmGitCodeCloneTaskExecutor.class);
	...
	public ADPaaSExecutorResponse execute(ADPaaSExecutorInput inputData, String tokenHeader) {
		...
		String uri=serviceUrl+URLConstants.SCM_GIT_CLONE_EXISTING_BRANCH_URL;
